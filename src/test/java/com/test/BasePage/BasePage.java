...
public class BasePage {
	protected static GenerateReport GenerateReports = null;
	protected static WebDriver driver;
	protected static WebDriverWait wait;
	protected static GenerateReport report;
...
//		Wait Wait1 = new FluentWait(driver).withTimeout(Duration.ofSeconds(30)).pollingEvery(Duration.ofSeconds(5))
	...
	public static void validateButtons(boolean result, String objName) {
		if(result)
			System.out.println(objName+" button checked");
		else {
			System.out.println(objName+"button unchecked");
